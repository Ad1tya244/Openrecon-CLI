...
def print_startup_banner():
    banner = f"""[bold cyan]  ___                   ____                     
 / _ \\ _ __   ___ _ __ |  _ \\ ___  ___ ___  _ __  
| | | | '_ \\ / _ \\ '_ \\| |_) / _ \\/ __/ _ \\| '_ \\ 
| |_| | |_) |  __/ | | |  _ <  __/ (_| (_) | | | |
 \\___/| .__/ \\___|_| |_|_| \\_\\___|\\___\\___/|_| |_|
      |_|                                          [/bold cyan]

[bold white]OpenRecon v{__version__}[/bold white]
[dim]Local OSINT & Reconnaissance CLI[/dim]
"""
